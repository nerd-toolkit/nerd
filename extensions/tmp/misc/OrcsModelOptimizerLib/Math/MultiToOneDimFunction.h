...
#ifndef NERD_MATH_MULTITOONEDIMFUNCTION_H
#define NERD_MATH_MULTITOONEDIMFUNCTION_H
...
/**
 * MultiToOneDimFunction
 * 
 * Used to calculate a values from a multidimensional function for only one dimension.
 */
class MultiToOneDimFunction : public OneDimFunction
{
  public:
    MultiToOneDimFunction(MultiDimFunction *function);
    ...
    virtual QVector<double> getMultiDimPoint(double x);
    
  protected:
    
    MultiDimFunction *mMultiDimFunction;
    
    QVector<double> mStartPoint;
    
    QVector<double> mDirection;
};
