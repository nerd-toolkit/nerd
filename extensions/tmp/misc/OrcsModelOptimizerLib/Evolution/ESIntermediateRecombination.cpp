...
#include "ESIntermediateRecombination.h"

#include "ESIndividual.h"

namespace nerd {

ESIntermediateRecombination::ESIntermediateRecombination()
{}
																								...
																								const int parameterIndex)
{
	...
	OptimizationDouble newParameter = getParentParameters(parents.first(), type).at(parameterIndex);
	newParameter.setValueInsideRange( parentParameterSum / (double) parents.size() );
