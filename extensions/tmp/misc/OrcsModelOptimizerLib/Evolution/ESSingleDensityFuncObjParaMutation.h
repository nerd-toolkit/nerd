...
#ifndef NERD_ESSingleDensityFuncObjParaMutation_H
#define NERD_ESSingleDensityFuncObjParaMutation_H
...
class ESSingleDensityFuncObjParaMutation : public ESObjectParametersMutation {
  public:
