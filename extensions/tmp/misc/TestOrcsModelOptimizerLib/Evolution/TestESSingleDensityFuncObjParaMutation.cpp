...
#include "TestESSingleDensityFuncObjParaMutation.h"
...
void TestESSingleDensityFuncObjParaMutation::testSingleDensityFuncObjParaMutation()
{
	ESInformation info;
	...
	ESSingleDensityFuncObjParaMutation *mutator = new ESSingleDensityFuncObjParaMutation();
	...
	QCOMPARE(newObjParas.at(1).value, 2.0 + (gaussianTwo * 0.5));
	QCOMPARE(newObjParas.at(2).value, 3.0 + (gaussianThree * 0.5));
