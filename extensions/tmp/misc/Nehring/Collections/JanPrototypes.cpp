...
#include "Models/JanPrey.h"
#include "Physics/FoodSource.h"

namespace nerd{

JanPrototypes::JanPrototypes() {
	PhysicsManager *pm = Physics::getPhysicsManager();
	
	pm->addPrototype("Prototypes/JanPrey", 
				new JanPrey("Prototypes/JanPrey"));
	pm->addPrototype("Prototypes/FoodSource", 
				new FoodSource("Prototypes/FoodSource"));
}
