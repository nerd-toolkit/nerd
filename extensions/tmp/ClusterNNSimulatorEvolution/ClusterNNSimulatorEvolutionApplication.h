...
#ifndef NERDClusterNNSimulatorEvolutionApplication_H
#define NERDClusterNNSimulatorEvolutionApplication_H

#include "Application/BaseApplication.h"
#include "Execution/EvolutionRunner.h"
#include "ClusterEvaluation/ClusterNetworkInSimEvaluationMethod.h"
#include "Gui/SimpleEvolutionMainWindow.h"
...
namespace nerd {
	 ...
	 */
	class ClusterNNSimulatorEvolutionApplication  : public BaseApplication {
	Q_OBJECT
	public:
		ClusterNNSimulatorEvolutionApplication();
		virtual ~ClusterNNSimulatorEvolutionApplication();
