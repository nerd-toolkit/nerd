...
ExampleActiveConstraint::ExampleActiveConstraint()
	: ActiveConstraint("ExamplePlasticityConstraint")
{
}
...
QString ExampleActiveConstraint::getName() const {
 ...
 */
GroupConstraint* ExampleActiveConstraint::createCopy() const {
	return new ExampleActiveConstraint(*this);
}
 ...
 */
void ExampleActiveConstraint::reset() {
}
 ...
 */
bool ExampleActiveConstraint::applyActiveConstraint(NeuronGroup *owner, ModularNeuralNetwork *net)
{
	if(owner == 0 || net == 0) {
		return false;
	}
