...
namespace nerd {
	...
	/**
	 * long term depression function 
	 */
	class LTD1Function : public SynapseFunction {
	public:
		LTD1Function();
		LTD1Function(const LTD1Function &other);
		virtual ~LTD1Function();
