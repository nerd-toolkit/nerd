...
#ifndef NERDExampleDynamicsPlotter_H
#define NERDExampleDynamicsPlotter_H
...
namespace nerd {
	...
	/**
	 * ExampleDynamicsPlotter.
	 *
	 */
	class ExampleDynamicsPlotter : public DynamicsPlotter {
	public:
		ExampleDynamicsPlotter();
		virtual ~ExampleDynamicsPlotter();
