...
#ifndef NERDTransients_Calculator_H
#define NERDTransients_Calculator_H
...
namespace nerd {
	...
	/**
	 * Transients_Calculator.
	 *
	 */
	class Transients_Calculator : public DynamicsPlotter {
		public:
			Transients_Calculator();
			virtual ~Transients_Calculator();
		...
		private:
			...
			NeuralNetworkElement* getVariedNetworkElement();
