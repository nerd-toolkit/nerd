...
#ifndef NERDDynamicsPlotConstants_H
#define NERDDynamicsPlotConstants_H
...
namespace nerd {
	...
	/**
	 * DynamicsPlotConstants.
	 *
	 */
	class DynamicsPlotConstants {
	public:
		//Object names
		...
		static const QString EVENT_CALCULATION_COMPLETED;
