...
class ODE_SliderMotor : public SliderMotor, public ODE_Joint {

	public:
		ODE_SliderMotor(const QString &name);
		ODE_SliderMotor(const ODE_SliderMotor &joint);
		virtual ~ODE_SliderMotor();
