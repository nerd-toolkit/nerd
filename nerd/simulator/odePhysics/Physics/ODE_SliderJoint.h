...
class ODE_SliderJoint : public ODE_Joint, public SliderJoint {

	public:
		ODE_SliderJoint(const QString &name);
		ODE_SliderJoint(const ODE_SliderJoint &joint);
		virtual ~ODE_SliderJoint();
