...
#ifndef ORCSSimple2D_CollisionHandler_H
#define ORCSSimple2D_CollisionHandler_H
...
namespace nerd {
	 ...
	 *
	 */
	class Simple2D_CollisionHandler : public CollisionHandler {
	public:
		Simple2D_CollisionHandler();
		virtual ~Simple2D_CollisionHandler();
