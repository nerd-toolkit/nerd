...
const QString SimulationConstants::PROTOTYPE_SIMPLE_LIGHT_SOURCE = "Prototypes/SimpleLightSource";
...
const QString SimulationConstants::PROTOTYPE_EXTERNAL_MOTOR_ADAPTER = "Prototypes/ExternalMotor";
