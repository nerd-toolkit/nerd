...
#ifndef NERDInterfaceSimObject_H
#define NERDInterfaceSimObject_H
...
namespace nerd {
	 ...
	 *
	 */
	class InterfaceSimObject : public SimObject {
	public:
		InterfaceSimObject(const QString &name, const QString &prefix);
