...
#ifndef NERDMSeriesV2Model_Obsolete_H
#define NERDMSeriesV2Model_Obsolete_H
...
namespace nerd {
	...
	/**
	 * MSeriesV2Model_Obsolete.
	 *
	 */
	class MSeriesV2Model_Obsolete : public ModelInterface {
	public:
		MSeriesV2Model_Obsolete(const QString &groupName = "", const QString &bodyPartList = "");
		MSeriesV2Model_Obsolete(const MSeriesV2Model_Obsolete &other);
		virtual ~MSeriesV2Model_Obsolete();
