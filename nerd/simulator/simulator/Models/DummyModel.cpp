 ...
 */
DummyModel::DummyModel(const QString &name)
	: ModelInterface(name)
{
}
 ...
 * Copy constructor. 
 * 
 * @param other the DummyModel object to copy.
 */
DummyModel::DummyModel(const DummyModel &other) 
...
SimObject* DummyModel::createCopy() const {
	return new DummyModel(*this);
}


void DummyModel::createModel() {
