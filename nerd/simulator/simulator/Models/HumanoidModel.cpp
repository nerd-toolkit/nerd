...
HumanoidModel::HumanoidModel(const QString &groupName) : ModelInterface(groupName) {
	mPosition->addValueChangedListener(this);
}

HumanoidModel::HumanoidModel(const HumanoidModel &model) : Object(), ValueChangedListener(), 
...
void HumanoidModel::createModel() {
...
// 	mNamePrefix.append("/");
	...
	//SimObject *forceSensor = pm->getPrototype("Prototypes/ForceSensor");
...
SimObject* HumanoidModel::createCopy() const {
	HumanoidModel *copy = new HumanoidModel("Default");
	return copy;
}
