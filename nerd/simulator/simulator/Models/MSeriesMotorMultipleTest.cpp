...
#include "MSeriesMotorMultipleTest.h"
#include "Core/Core.h"
...
MSeriesMotorMultipleTest::MSeriesMotorMultipleTest(const QString &groupName) : ModelInterface(groupName) {
	mPosition->addValueChangedListener(this);

}

MSeriesMotorMultipleTest::MSeriesMotorMultipleTest(const MSeriesMotorMultipleTest &model) : Object(), ValueChangedListener(), 
...
MSeriesMotorMultipleTest::~MSeriesMotorMultipleTest(){
}

void MSeriesMotorMultipleTest::layoutObjects() {
...
SimObject* MSeriesMotorMultipleTest::createCopy() const {
	MSeriesMotorMultipleTest *copy = new MSeriesMotorMultipleTest("Default");
	return copy;
}
