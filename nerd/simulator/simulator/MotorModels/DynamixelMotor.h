...
#ifndef NERD_DYNAMIXELMOTOR_H
#define NERD_DYNAMIXELMOTOR_H
...
class DynamixelMotor : public HingeMotor {
  
  public:
    DynamixelMotor(const QString &name);
    DynamixelMotor(const DynamixelMotor &dynamixelMotor);
