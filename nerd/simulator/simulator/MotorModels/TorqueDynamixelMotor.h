...
#ifndef NERDTorqueDynamixelMotor_H
#define NERDTorqueDynamixelMotor_H
...
namespace nerd {
	...
	/**
	 * TorqueDynamixelMotor.
	 *
	 */
	class TorqueDynamixelMotor : public HingeMotor {
	public:
		TorqueDynamixelMotor(const QString &name);
		TorqueDynamixelMotor(const TorqueDynamixelMotor &other);
		virtual ~TorqueDynamixelMotor();
