...
#include "ClusterNNSimulatorEvolutionApplication.h"
#include "Core/Core.h"
...
ClusterNNSimulatorEvolutionApplication::ClusterNNSimulatorEvolutionApplication()
...
QString ClusterNNSimulatorEvolutionApplication::getName() const
{
	return "ClusterNNSimulatorEvolutionApplication";
}

bool ClusterNNSimulatorEvolutionApplication::runApplication() {
...
bool ClusterNNSimulatorEvolutionApplication::setupGui() {
	bool enableGui = true;
...
bool ClusterNNSimulatorEvolutionApplication::setupApplication()
{
	bool ok = true;
...
// 	Statistics::install();
	...
	if(!buildEvolutionSystem()) {
		Core::log("ClusterNNSimulatorEvolutionApplication: Problem while "
...
bool ClusterNNSimulatorEvolutionApplication::buildEvolutionSystem() {
