...
#include "LocalNNSimulatorEvolutionApplication.h"
#include "Core/Core.h"
...
#include "Gui/EvolutionProgressBar.h"
...
LocalNNSimulatorEvolutionApplication::LocalNNSimulatorEvolutionApplication()
...
QString LocalNNSimulatorEvolutionApplication::getName() const
{
	return "LocalNNSimulatorEvolutionApplication";
}

bool LocalNNSimulatorEvolutionApplication::runApplication() {
...
bool  LocalNNSimulatorEvolutionApplication::setupGui() {
...
bool LocalNNSimulatorEvolutionApplication::setupApplication()
{
	bool ok = true;
...
bool LocalNNSimulatorEvolutionApplication::buildSimulationModel()
{
	Physics::getSimulationEnvironmentManager()->createSnapshot();
...
bool LocalNNSimulatorEvolutionApplication::buildEvolutionSystem() {
