...
ESTestFitnessEvaluation::ESTestFitnessEvaluation(double fitness)
	: mFitness(fitness)
{
}	
	
void ESTestFitnessEvaluation::setFitness(double fitness)
{
	mFitness = fitness;
}
																						...
																						const ESInformation &information)
{
	...
	for(int i = 0; i < population.size(); i++){
		population.at(i)->setFitness(mFitness);
	}
