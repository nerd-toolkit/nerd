...
#ifndef NERD_ESMultiDensityFuncObjParaMutation_H
#define NERD_ESMultiDensityFuncObjParaMutation_H
...
namespace nerd {
	...
	class ESMultiDensityFuncObjParaMutation : public ESObjectParametersMutation {
  public:
