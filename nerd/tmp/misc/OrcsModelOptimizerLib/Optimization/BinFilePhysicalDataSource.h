...
#ifndef NERD_BINFILEPHYSICALDATASOURCE_H
#define NERD_BINFILEPHYSICALDATASOURCE_H
...
typedef QMap<uint, double> PositionValueMap;
  
class BinFilePhysicalDataSource : public PhysicalDataSource {
  public:
  ...
  protected:
    static const uint DATATYPE_LENGTH; 
    
    enum error {NOERROR, NOSYNCVALUE, FRAMEINCOMPLETE};
    ...
    uint mTimeChangeIntervall;
    
    QVector< QVector<double>* > mData;
  
    virtual int readDataFrames(int motionLengthInSteps);
    
    virtual error readNextFrame(PositionValueMap *posValMap, bool skipDataBeforeFrame);
