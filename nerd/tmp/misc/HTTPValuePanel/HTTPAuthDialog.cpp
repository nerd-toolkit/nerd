...
HTTPAuthDialog::HTTPAuthDialog(QWidget *) {
	setWindowTitle("Http authentication required");

	setMinimumWidth(350);
	mUserEdit = new QLineEdit();
	mUserLabel = new QLabel("&Username:");
	...
	mLayout->addWidget(mUserLabel);
	mLayout->addWidget(mUserEdit);
	mLayout->addWidget(mPasswordLabel);
	mLayout->addWidget(mPasswordEdit);
