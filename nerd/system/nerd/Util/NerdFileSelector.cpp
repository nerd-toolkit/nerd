...
/**
 * Constructs a new NerdFileSelector.
 */
QString NerdFileSelector::getFileName(const QString &fileChooserTitle, bool existingFilesOnly,
						QWidget *parent) {
	...
	if(existingFilesOnly) {
		fileName = QFileDialog::getOpenFileName(parent, fileChooserTitle, fileChooserDirectory);
	}
	else {
		fileName = QFileDialog::getSaveFileName(parent, fileChooserTitle, fileChooserDirectory);
	}
