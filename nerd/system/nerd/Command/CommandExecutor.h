...
#ifndef NERDCommandExecutor_H
#define NERDCommandExecutor_H

#include <QString>
#include <QHash>
#include <QList>
#include "Command/CommandExecutionListener.h"
...
namespace nerd {
	...
	private:
		void destroyList(QList<Command*> &list);
		void updateActions();

	private:
		QList<Command*> mUndoList;
		QList<Command*> mDoList;
		QList<CommandExecutionListener*> mExecutionListeners;
		QAction *mUndoAction;
		QAction *mRedoAction;
		bool mIsExecuting;
		QMutex *mExecutionMutex;
	};
