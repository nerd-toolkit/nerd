...
#ifndef ORCSGuiManager_H
#define ORCSGuiManager_H
...
namespace nerd {
	 ...
	 *
	 */
	class GuiManager : public SystemObject {
	public:
		GuiManager();
		...
		static GuiManager* getGlobalGuiManager();
		bool registerAsGlobalObject();

		virtual bool addWidget(const QString &name, QWidget *widget);
