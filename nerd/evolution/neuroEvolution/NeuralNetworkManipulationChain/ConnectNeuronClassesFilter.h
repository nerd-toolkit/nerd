...
#ifndef NERDConnectNeuronClassesFilter_H
#define NERDConnectNeuronClassesFilter_H
...
namespace nerd {
	...
	/**
	 * ConnectNeuronClassesFilter.
	 *
	 */
	class ConnectNeuronClassesFilter : public NeuralNetworkManipulationOperator {
	public:
		ConnectNeuronClassesFilter(const QString &name);
		ConnectNeuronClassesFilter(const ConnectNeuronClassesFilter &other);
		virtual ~ConnectNeuronClassesFilter();
