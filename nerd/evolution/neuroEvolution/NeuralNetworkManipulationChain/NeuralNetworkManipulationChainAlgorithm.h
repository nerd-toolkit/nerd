...
#ifndef NERDNeuralNetworkManipulationChainAlgorithm_H
#define NERDNeuralNetworkManipulationChainAlgorithm_H
...
namespace nerd {
	...
	/**
	 * NeuralNetworkManipulationChainAlgorithm.
	 */
	class NeuralNetworkManipulationChainAlgorithm : public EvolutionAlgorithm {
	public:
		NeuralNetworkManipulationChainAlgorithm(const QString &name);
		NeuralNetworkManipulationChainAlgorithm(
				const NeuralNetworkManipulationChainAlgorithm &other);
		virtual ~NeuralNetworkManipulationChainAlgorithm();
