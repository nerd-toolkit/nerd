...
#ifndef NERDInsertBiasOperator_H
#define NERDInsertBiasOperator_H
...
namespace nerd {
	 ...
	 *
	 */
	class InsertBiasOperator : public NeuralNetworkManipulationOperator {
	public:
		InsertBiasOperator(const QString &name);
		InsertBiasOperator(const InsertBiasOperator &other);
		virtual ~InsertBiasOperator();
	...
	private:
		...
		IntValue *mMaximalNumberOfNewBiases;
	};
