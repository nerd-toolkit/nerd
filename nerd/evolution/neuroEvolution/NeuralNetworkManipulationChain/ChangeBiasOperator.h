...
#ifndef NERDChangeBiasOperator_H
#define NERDChangeBiasOperator_H
...
namespace nerd {
	 ...
	 * ChangeBiasOperator.
	 */
	class ChangeBiasOperator : public NeuralNetworkManipulationOperator {
	public:
		ChangeBiasOperator(const QString &name);
		ChangeBiasOperator(const ChangeBiasOperator &other);
		virtual ~ChangeBiasOperator();
	...
	private:
		...
		NormalizedDoubleValue *mToggleBiasEnableProbability;
		DoubleValue *mMaxBias;
		DoubleValue *mMinBias;
		DoubleValue *mDeviation;
		BoolValue *mUseGaussDistribution;
		NormalizedDoubleValue *mReinitializeBiasProbability;
	};
}
