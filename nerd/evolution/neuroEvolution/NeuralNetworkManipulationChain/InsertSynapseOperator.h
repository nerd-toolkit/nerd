...
#ifndef NERDInsertSynapseOperator_H
#define NERDInsertSynapseOperator_H
...
namespace nerd {
	...
	/**
	 * InsertSynapseOperator.
	 */
	class InsertSynapseOperator : public NeuralNetworkManipulationOperator {
	public:
		InsertSynapseOperator(const QString &name);
		InsertSynapseOperator(const InsertSynapseOperator &other);
		virtual ~InsertSynapseOperator();
	...
	private:
		...
		BoolValue *mAllowSynapsesAsTargets;
	};
}
