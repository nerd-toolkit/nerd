...
namespace nerd {
	...
	Q_OBJECT
	public:
		EvolutionMainControlParameterPanel(const QString &worldName);
	...
	public slots:
		void selectionMethodIndexChanged(int index);
	...
	private:
		...
		QString mWorldName;
		QComboBox *mSelectionMethodBox;
		QStackedLayout *mSelectionMethodParamLayout;
		QList<DoubleValue*> mSelectionProportions;
