...
#ifndef NERDControlInterfaceAdapter_H
#define NERDControlInterfaceAdapter_H
...
namespace nerd {
	 ...
	 */
	class ControlInterfaceAdapter : public ControlInterface {
	public:
		ControlInterfaceAdapter();
		virtual ~ControlInterfaceAdapter();
