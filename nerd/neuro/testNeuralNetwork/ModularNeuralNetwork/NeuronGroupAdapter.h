...
#ifndef NERDNeuronGroupAdapter_H
#define NERDNeuronGroupAdapter_H
...
namespace nerd {
	 ...
	 * NeuronGroupAdapter.
	 */
	class NeuronGroupAdapter : public NeuronGroup {
	public:
		NeuronGroupAdapter(const QString &name, qulonglong id = 0, bool *destroyFlag = 0);
		NeuronGroupAdapter(const NeuronGroupAdapter &other);
		virtual ~NeuronGroupAdapter();
	...
	private:
		int mCountSetOwner;
		int mCountAddNeuron;
		int mCountRemoveNeuron;
		int mCountRemoveAllNeurons;
		int mCountAddConstraint;
		int mCountRemoveConstraint;
		int mCountMoveToNetwork;
		int mCountEquals;
		bool *mDestroyFlag;
	};
