...
#ifndef NERDSimpleNeuronItem_H
#define NERDSimpleNeuronItem_H
...
namespace nerd {
	 ...
	 *
	 */
	class SimpleNeuronItem : public NeuronItem {
	public:
		SimpleNeuronItem(NetworkVisualization *owner);
		SimpleNeuronItem(const SimpleNeuronItem &other);
		virtual ~SimpleNeuronItem();

		virtual NeuronItem* createCopy() const;
	...
	private:
		double mRadius;
		bool mShowOutputActivityByColor;
		bool mShowActivityByColor;
