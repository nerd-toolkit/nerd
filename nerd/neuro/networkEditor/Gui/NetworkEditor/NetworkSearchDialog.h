...
#ifndef NERDNetworkSearchDialog_H
#define NERDNetworkSearchDialog_H
...
class ParameterizedObject;
	 ...
	 *
	 */
	class NetworkSearchDialog : public QWidget {
	Q_OBJECT
	public:
		NetworkSearchDialog(NeuralNetworkEditor *owner, QWidget *parent = 0);
		virtual ~NetworkSearchDialog();
