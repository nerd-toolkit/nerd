...
#ifndef NERDSelectionRectItem_H
#define NERDSelectionRectItem_H
...
namespace nerd {
	 ...
	 *
	 */
	class SelectionRectItem : public PaintItem {
	public:
		SelectionRectItem();
		virtual ~SelectionRectItem();

		void setSize(double width, double height);
		void addToSize(const QPointF &point);
		int getWidth() const;
		int getHeight() const;
