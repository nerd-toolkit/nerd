...
#ifndef NERDSimpleGroupItem_H
#define NERDSimpleGroupItem_H
...
namespace nerd {
	 ...
	 *
	 */
	class SimpleGroupItem : public GroupItem {
	public:
		SimpleGroupItem(NetworkVisualization *owner);
		SimpleGroupItem(const SimpleGroupItem &other);
		virtual ~SimpleGroupItem();

		virtual GroupItem* createCopy() const;
