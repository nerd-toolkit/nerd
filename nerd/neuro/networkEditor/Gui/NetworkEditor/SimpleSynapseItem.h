...
#ifndef NERDSimpleSynapseItem_H
#define NERDSimpleSynapseItem_H
...
namespace nerd {
	 ...
	 *
	 */
	class SimpleSynapseItem : public SynapseItem {
	public:
		SimpleSynapseItem(NetworkVisualization *owner);
		SimpleSynapseItem(const SimpleSynapseItem &other);
		virtual ~SimpleSynapseItem();

		virtual SynapseItem* createCopy() const;
