...
#include "LoadRecentNetworkAction.h"
#include <iostream>
#include <QList>
#include "Core/Core.h"
 ...
 * Destructor.
 */
LoadRecentNetworkAction::~LoadRecentNetworkAction() {
}


QString LoadRecentNetworkAction::getFileName() const {
	return mFileName;
}

	
void LoadRecentNetworkAction::loadNetwork() {
	if(mOwner != 0) {
		mOwner->loadNetwork(mFileName, false);
	}
}
