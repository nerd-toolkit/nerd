...
#ifndef NERDReconnectSynapseNetworkTool_H
#define NERDReconnectSynapseNetworkTool_H
...
namespace nerd {
	...
	/**
	 * ReconnectSynapseNetworkTool.
	 *
	 */
	class ReconnectSynapseNetworkTool : public NetworkManipulationTool, 
										public VisualizationMouseListener {
	public:
		ReconnectSynapseNetworkTool(QObject *owner);
		virtual ~ReconnectSynapseNetworkTool();
	...
	private:
		Synapse *mSynapse;
		Neuron *mPreviousNeuron;
		Synapse *mPreviousSynapse;
	};
