...
#ifndef NERDShowElementPairTool_H
#define NERDShowElementPairTool_H
...
namespace nerd {
	 ...
	 *
	 */
	class ShowElementPairTool  : public NetworkManipulationTool,
								 public VisualizationMouseListener
	{
	public:
		ShowElementPairTool(QObject *owner);
		virtual ~ShowElementPairTool();
