...
#ifndef NERDEditorMessageWidget_H
#define NERDEditorMessageWidget_H
...
namespace nerd {
	 ...
	 *
	 */
	class EditorMessageWidget : public EditorToolWidget{
	Q_OBJECT
	public:
		EditorMessageWidget(NeuralNetworkEditor *owner);
