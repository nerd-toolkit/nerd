...
#ifndef NERDInsertNeuronNetworkTool_H
#define NERDInsertNeuronNetworkTool_H
...
namespace nerd {
	...
	/**
	 * InsertNeuronNetworkTool.
	 *
	 */
	class InsertNeuronNetworkTool : public NetworkManipulationTool, 
									public VisualizationMouseListener 
	{
	Q_OBJECT
	public:
		InsertNeuronNetworkTool(QObject *owner);
		virtual ~InsertNeuronNetworkTool();
