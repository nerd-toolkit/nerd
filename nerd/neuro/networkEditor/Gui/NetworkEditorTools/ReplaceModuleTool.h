...
#ifndef NERDReplaceModuleTool_H
#define NERDReplaceModuleTool_H
...
namespace nerd {
	 ...
	 *
	 */
	class ReplaceModuleTool : public NetworkManipulationTool, 
									 public VisualizationMouseListener 
	{
	public:
		ReplaceModuleTool(QObject *owner);
		virtual ~ReplaceModuleTool();
