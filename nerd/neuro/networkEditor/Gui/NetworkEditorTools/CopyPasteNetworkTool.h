...
#ifndef NERDCopyPasteNetworkTool_H
#define NERDCopyPasteNetworkTool_H
...
namespace nerd {
	...
	/**
	 * CopyPasteNetworkTool.
	 *
	 */
	class CopyPasteNetworkTool : public NetworkManipulationTool {
	public:
		CopyPasteNetworkTool(QObject *owner);
		virtual ~CopyPasteNetworkTool();
