...
#ifndef NERDInsertSynapseNetworkTool_H
#define NERDInsertSynapseNetworkTool_H
...
namespace nerd { 
	...
	/**
	 * InsertSynapseNetworkTool.
	 *
	 */
	class InsertSynapseNetworkTool : public NetworkManipulationTool, 
									 public VisualizationMouseListener 
	{
	Q_OBJECT

	public:
		InsertSynapseNetworkTool(QObject *owner);
		virtual ~InsertSynapseNetworkTool();
