...
#ifndef NERDRemoveObjectsNetworkTool_H
#define NERDRemoveObjectsNetworkTool_H
...
namespace nerd {
	...
	/**
	 * RemoveObjectsNetworkTool.
	 *
	 */
	class RemoveObjectsNetworkTool : public NetworkManipulationTool, 
									public VisualizationMouseListener 
	{
	Q_OBJECT
	public:
		RemoveObjectsNetworkTool(QObject *owner);
		virtual ~RemoveObjectsNetworkTool();
