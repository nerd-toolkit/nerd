...
#ifndef NERDGrabNetworkElementIdTool_H
#define NERDGrabNetworkElementIdTool_H
...
namespace nerd {
	...
	/**
	 * GrabNetworkElementIdTool.
	 *
	 */
	class GrabNetworkElementIdTool  : public NetworkManipulationTool, 
									  public VisualizationMouseListener
	{
	Q_OBJECT
	public:
		GrabNetworkElementIdTool(QObject *owner);
		virtual ~GrabNetworkElementIdTool();
