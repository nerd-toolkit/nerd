...
#ifndef NERDInsertModuleNetworkTool_H
#define NERDInsertModuleNetworkTool_H
...
namespace nerd {
	...
	/**
	 * InsertModuleNetworkTool.
	 *
	 */
	class InsertModuleNetworkTool  : public NetworkManipulationTool, 
									public VisualizationMouseListener
	{
	Q_OBJECT
	public:
		InsertModuleNetworkTool(QObject *owner);
		virtual ~InsertModuleNetworkTool();
