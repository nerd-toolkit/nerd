...
#ifndef NERDModuleManagementWidget_H
#define NERDModuleManagementWidget_H
...
namespace nerd {
	 ...
	 *
	 */
	class ModuleManagementWidget : public EditorToolWidget, public virtual VisualizationMouseListener {
	Q_OBJECT
	public:
		ModuleManagementWidget(NeuralNetworkEditor *owner);
		virtual ~ModuleManagementWidget();
	...
	private:
		QListWidget *mModuleList;
		QScrollArea *mModuleListScrollArea;
		QLineEdit *mModuleNameField;
