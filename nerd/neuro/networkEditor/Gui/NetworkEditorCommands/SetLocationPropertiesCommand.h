...
#ifndef NERDSetLocationPropertiesCommand_H
#define NERDSetLocationPropertiesCommand_H
...
namespace nerd {
	...
	private:
		...
		QList<NeuralNetworkElement*> mChangedElements;	
		QList<QString> mOldPropertyEntires;
		QList<QString> mOldSizeEntries;
	};
