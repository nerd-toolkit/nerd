...
namespace nerd {
	...
	public:
		...
		static QList<Neuron*> getNeuronsFromIdList(NeuralNetwork *network, const QString &idList);
		static QList<Synapse*> getSynapsesFromIdList(NeuralNetwork *network, const QString &idList);
