...
#ifndef NERDSimpleSynapseFunction_H
#define NERDSimpleSynapseFunction_H
...
namespace nerd {
	 ...
	 */
	class SimpleSynapseFunction : public SynapseFunction {
	public:
		SimpleSynapseFunction();
		SimpleSynapseFunction(const SimpleSynapseFunction &other);
		virtual ~SimpleSynapseFunction();
