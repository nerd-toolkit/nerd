...
#ifndef NERDASeriesSynapseFunction_H
#define NERDASeriesSynapseFunction_H
...
namespace nerd {
	 ...
	 */
	class ASeriesSynapseFunction : public SynapseFunction {
	public:
		ASeriesSynapseFunction();
		ASeriesSynapseFunction(const ASeriesSynapseFunction &other);
		virtual ~ASeriesSynapseFunction();
