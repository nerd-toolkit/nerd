...
#ifndef NERDUniversalNeuroScriptingContext_H
#define NERDUniversalNeuroScriptingContext_H
...
namespace nerd {
	...
	/**
	 * UniversalNeuroScriptingContext.
	 *
	 */
	class UniversalNeuroScriptingContext : public UniversalScriptingContext {
	...
	private:
		UniversalNeuroScriptingContext(const UniversalNeuroScriptingContext &other);

	private:
		ScriptedNetworkManipulator *mNetworkManipulator;
		StringValue *mNameOfAgentInterface;
	};
