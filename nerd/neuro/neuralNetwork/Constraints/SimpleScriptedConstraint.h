...
#ifndef NERDSimpleScriptedConstraint_H
#define NERDSimpleScriptedConstraint_H
...
namespace nerd {
	...
	/**
	 * SimpleScriptedConstraint.
	 *
	 */
	class SimpleScriptedConstraint : public GroupConstraint {
	public:
		SimpleScriptedConstraint();
		SimpleScriptedConstraint(const SimpleScriptedConstraint &other);
		virtual ~SimpleScriptedConstraint();
