...
#include "AdditiveTimeDiscreteActivationFunction.h"
...
ActivationFunction* AdditiveTimeDiscreteActivationFunction::createCopy() const {
	return new AdditiveTimeDiscreteActivationFunction(*this);
}

void AdditiveTimeDiscreteActivationFunction::reset(Neuron*) {
}
...
bool AdditiveTimeDiscreteActivationFunction::equals(ActivationFunction *activationFunction) const {
	if(ActivationFunction::equals(activationFunction) == false) {
		return false;
	}
	AdditiveTimeDiscreteActivationFunction *af =
 			dynamic_cast<AdditiveTimeDiscreteActivationFunction*>(activationFunction);
