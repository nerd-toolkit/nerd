...
#ifndef NERDASeriesActivationFunction_H
#define NERDASeriesActivationFunction_H
...
namespace nerd {
	 ...
	 */
	class ASeriesActivationFunction : public ActivationFunction {
	public:
		ASeriesActivationFunction();
		ASeriesActivationFunction(const ASeriesActivationFunction &other);
		virtual ~ASeriesActivationFunction();
