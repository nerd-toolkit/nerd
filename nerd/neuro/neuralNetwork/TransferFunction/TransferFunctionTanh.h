...
#ifndef NERDTransferFunctionTanh_H
#define NERDTransferFunctionTanh_H
...
namespace nerd {
	 ...
	 */
	class TransferFunctionTanh : public TransferFunction {
	public:
		TransferFunctionTanh();
		TransferFunctionTanh(const TransferFunctionTanh &other);
		virtual ~TransferFunctionTanh();
