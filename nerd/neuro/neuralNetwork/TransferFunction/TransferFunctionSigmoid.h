...
#ifndef NERDTransferFunctionSigmoid_H
#define NERDTransferFunctionSigmoid_H
...
namespace nerd {
	...
	public:
		TransferFunctionSigmoid();
		TransferFunctionSigmoid(const TransferFunctionSigmoid &other);
		virtual ~TransferFunctionSigmoid();
