...
#ifndef NERDSynapseTarget_H
#define NERDSynapseTarget_H
...
namespace nerd {
	 ...
	 * SynapseTarget
	 */
	class SynapseTarget : public NeuralNetworkElement {
	public:
		SynapseTarget() : NeuralNetworkElement() {};
		SynapseTarget(const NeuralNetworkElement &other) : NeuralNetworkElement(other) {};
		virtual ~SynapseTarget() {};
