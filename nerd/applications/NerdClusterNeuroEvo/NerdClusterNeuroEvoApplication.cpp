...
#include "NerdClusterNeuroEvoApplication.h"
#include "Core/Core.h"
...
NerdClusterNeuroEvoApplication::NerdClusterNeuroEvoApplication()
...
QString NerdClusterNeuroEvoApplication::getName() const
{
	return "NerdClusterNeuroEvoApplication";
}

bool NerdClusterNeuroEvoApplication::runApplication() {
...
bool NerdClusterNeuroEvoApplication::setupApplication()
{
	bool ok = true;
...
// 	settingsLogger->addValues("(?!.*/Evo/.*/Fitness/.*/Fitness/.*)(?!.*/Performance/.*)/Evo/Main/Algorithm/.*");
// 	settingsLogger->addValues("(?!.*/Evo/.*/Fitness/.*/Fitness/.*)(?!.*/Performance/.*)/Evo/Main/Pop/.*");
...
bool NerdClusterNeuroEvoApplication::buildEvolutionSystem() {
